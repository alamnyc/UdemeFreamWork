...
public class AppiumTest { @Test	 public void MobileTest() {
		...
		caps.setCapability("noReset", "true");  //Instantiate Appium Driver
		try {
		...
		((AndroidDriver<MobileElement>) driver).pressKeyCode(66); //OR
